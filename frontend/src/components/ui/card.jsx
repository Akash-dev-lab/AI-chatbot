...
export function Card({ className = "", ...props }) {
  return <div className={`rounded-lg border p-10 bg-card text-card-foreground shadow-sm ${className}`} {...props} />;
}
...
export function CardFooter({ className = "", ...props }) {
  return <div className={`flex items-center p-4 border-t ${className}`} {...props} />;
}
