...
export const fetchCurrentUser = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await axios.get("https://ai-chatbot-qe6a.onrender.com/api/auth/profile", {
...
export const logoutUser = createAsyncThunk(
  ...
  async (_, { dispatch, rejectWithValue }) => {
    try {
      await axios.post(
        "https://ai-chatbot-qe6a.onrender.com/api/auth/logout",
        {},
        { withCredentials: true }
      );
      dispatch(clearUser());
  ...
  async (file, { rejectWithValue, dispatch }) => {
    try {
      ...
      const res = await axios.post(
        "https://ai-chatbot-qe6a.onrender.com/api/auth/upload-profile",
        formData,
        {
          withCredentials: true,
